      ...
      <View style={[styles.footer]} >
        ...
        <View style={{flex:1, flexDirection: 'row',justifyContent: 'space-between', }}>
                
          {
            props.form_no == 7 ?
            (
              <View onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box,{backgroundColor:'#359814'}]} >
                <Text onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box_data]} >  فصل کی صحت</Text>
                <Text onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box_data]} >  CROP HEALTH</Text>
              </View>
             
            ):(
            
              <View onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box]} >
                <Text onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box_data]} >  فصل کی صحت</Text>
                <Text onPress={ ()=> props.nav.navigation.navigate('crop_health_report') } style={[styles.footer_box_data]} >  CROP HEALTH</Text>
              </View>
