    ...
    <>
      <View style={{
        ...
        <View style={{alignSelf:"center",marginTop:30,width:"95%" }} >
          ...
          <Text>(آپ کس طرح آبپاشی کے لئے کھیت تیار کرتے ہیں)</Text>
          ...
          <View style={{marginTop:20,height:'5%'}} >
            <Text>Type of soil (مٹی کی قسم)</Text>
            <Picker 
            ...
            >
              ...
              <Picker.Item label="Clay  چکنیمٹی مٹی" value="1" />
              <Picker.Item label="Loam مکس" value="2" />
              <Picker.Item label="Sandy loam زیادہ ریتیلی" value="3" />
          ...
          <View style={{alignSelf:"center",marginTop:10,width:"95%" }} >
            ...
            <Text>کیا آپ لیزر لینڈ لیولنگ کرتے ہیں؟</Text>
          ...
          <Text>Date you apply laser level?</Text>
          <Text>کب آپ لیزر لیول لگاتے ہیں؟</Text>
          </View>
          ...
          <View style={{ marginTop:30 }}>
          <Text>Date of first irrigation to farm?</Text>
          <Text> آپ نے پہلا پانی کب لگایا؟</Text>
          </View>
          <View style={[styles.input_email,{marginTop:20,flexDirection:'row',justifyContent:'space-between',backgroundColor:'gray'}]} >
            <DatePicker
          ...
          <Text>How much time is required for a complete irrigation in your farm?</Text>
          <Text>فصل کو پانی لگانے میں کتنا وقت درکار ہوتا ہے؟</Text>
          <TextInput placeholderTextColor="#272626" onFocus={() => focus()} onBlur={() => blur()} value={props.f_irrigation_frequency[index2].irrigation_frequency} onChangeText={(val) => changeData(val,6,props.index2)} keyboardType="numeric" placeholder="" style={[styles.input_email]} />
          <View>
            <Text>What is your farm distance from water course?</Text>
            <Text>فارم موگے سے کتنے فاصلے پر ہے؟</Text>
          </View>
