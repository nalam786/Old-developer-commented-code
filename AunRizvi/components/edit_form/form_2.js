      ...
      <View
        ...
        <View style={{alignSelf: 'center', marginTop: 30, width: '95%'}}>
          ...
          <View
            ...
            <View
              ...
              <CheckBox
                ...
                value={
                  1 ==
                  props.f_prepared_field_irrigation[index2]
          ...
          <TextInput
            ...
            value={props.f_irrigation_frequency[index2].irrigation_frequesncy}
            onChangeText={val => changeData(val, 6, props.index2)}
            placeholder="How much time is required for a complete irrigation in your farm?"
          ...
          <View style={{marginTop: 20}}>
            <Picker
              selectedValue={
                props.f_farm_distance_watercourse[index2]
              ...
              <Picker.Item
                label="What is your farm distance from water course?"
                value=""
              />
