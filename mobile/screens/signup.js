        ...
        <View style={{flex: 1,flexDirection: 'column',justifyContent: 'space-between',}}>
          <View style={[styles.triangleCorner]} />
            ...
            <View style={{alignSelf:"center" }} >
              ...
              <TextInput placeholderTextColor="#272626" onChangeText={(val) => textInputChange(val,1)} placeholder="Full Name" style={[styles.input_email]} />
              
              <View style={{ flexDirection: 'row'}}>
              <TextInput placeholderTextColor="#272626" onChangeText={(val) => textInputChange(val,2)} placeholder="+92"keyboardType="numeric"maxLength={4} style={[styles.input_phone_code]} />
