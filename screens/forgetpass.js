...
const send_sms = async (phone) => {
  ...
  await fetch(URL.url + 'users/phone_varification', {
    ...
    .then((resjson) => {
      alert(34567)
      fetch('https://connect.jazzcmt.com/sendsms_url.html?Username=03040740644&Password=Flux_12345&From=Business&To=92'+phone+'&Message=Your Infarmer Registration code is'+resjson.password, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json'
        ...
        <View style={{ flexDirection: 'row',width:'80%'}}>
            ...
            data.country.map((
              ...
              keys, //you can use  mandatory field here
                ...
                <Picker.Item label={country.phonecode} value={country.phonecode} />
                ))
              }
              </Picker>
            </View>
