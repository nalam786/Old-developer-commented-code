...
class PolygonCreator extends React.Component {
  ...
  signup = async value => {
    ...
    await fetch(URL.url + 'expected_yields/expected_yields_get', {
      method: 'POST',
      headers: {
      ...
      .then(async resjson => {
        ...
        //     let temp = {
        //       longitude: map.geometry.coordinates[0][i][0],
        //       latitude: map.geometry.coordinates[0][i][1],
        //     };
        //     array.push(temp);
        //   }
  ...
  render() {
    console.log('third page', this.props.route.params.farm_id);
