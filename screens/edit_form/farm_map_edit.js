...
class PolygonCreator extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // polygons: [
      //   [74.33508060872555, 31.52161381070511],
      //   [74.38612639904022, 31.54935752144726],
      //   [74.38768945634365, 31.495032564881118],
      //   [74.33508060872555, 31.52161381070511],
      // ],
      polygons: [],
      editing: null,
  ...
  render() {
    console.log('check', this.props.route.params.map_upd_data);
    const mapOptions = {
      scrollEnabled: true,
    };
