...
console.log(this.state.editing);
    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          {this.state.editing && (
            ...
            this.state.editing.coordinates.map((latlong, key) => (
              <Marker pinColor={'green'} coordinate={latlong} title={"Point" + key}  />
            ))
          )}
        ...
        <TouchableOpacity
            onPress={() => this.undo()}
            style={[styles.bubble, styles.button,{width:'100%',backgroundColor: 'rgba(000,000,000,0.7)',borderRadius:0
          }]}
