...

          {
            ...
            (
              ...
              <View onPress={ ()=> props.nav.navigation.navigate('expected_yield_form') } style={[styles.footer_box,{backgroundColor:'#359814'}]} >
                ...
                <Text onPress={ ()=> props.nav.navigation.navigate('expected_yield_form') } style={[styles.footer_box_data]} >  EXCEPTED CROP YIELD</Text>
              </View>
              ...
              <View onPress={ ()=> props.nav.navigation.navigate('expected_crop_yield_form') } style={[styles.footer_box]} >
                ...
                <Text onPress={ ()=> props.nav.navigation.navigate('expected_crop_yield_form') } style={[styles.footer_box_data]} >  EXCEPTED CROP YIELD</Text>
              </View>
