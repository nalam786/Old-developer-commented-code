  ...
  return (
    <>
      ...
      {/* <ScrollView style={styles.scrollView}> */}
        ...
        <View style={[{marginTop:20,flexDirection:'row',justifyContent:'space-between'}]} >
          ...
          <Text onPress={ ()=> removeData(2,100,props.index2) } style={{marginBottom:40,color:'green',fontSize:25,fontWeight:'bold', }} >X </Text>
              ...
              <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
                    ...
                    value={'prepare_for_irrigation_1'==props.radio_input[props.index2].radio_input}
                    onValueChange={(val) => changeData('prepare_for_irrigation_1',100,props.index2)}
                    // checked={true}
                    ...
                    <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
                     <CheckBox style={{alignSelf:"center",borderRadius:50, }}
                    value={'prepare_for_irrigation_2'==props.radio_input[props.index2].radio_input}
                    onValueChange={(val) => changeData('prepare_for_irrigation_2',100,props.index2)}
                    />
                    <Text style={{alignSelf:"center" }} >Basian Irrigation</Text>
                    </View>
                    <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
                     <CheckBox style={{alignSelf:"center",borderRadius:50, }}
                   value={'prepare_for_irrigation_3'==props.radio_input[props.index2].radio_input}
                   onValueChange={(val) => changeData('prepare_for_irrigation_3',100,props.index2)}
                    />
              ...
              <View style={[styles.border_bottom,{ borderBottomWidth:1,borderBottomColor:'gray',}]} ></View>
        ...
        <TextInput placeholderTextColor="#272626" value={props.text_input[props.index2].text_input} onChangeText={(val) => changeData(val,5,props.index2)} placeholder="Area (ACERS)" style={[styles.input_email]} />
