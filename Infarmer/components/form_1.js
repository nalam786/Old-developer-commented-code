...
const form_1 = (props) =>  {
  ...
  console.log(props.map_cord.cordinates);
  ...
  const textInputChange = (v,no) => {
    ...
    switch (no) {
      ...
      case 1:
        ...
        console.log('Farm Name:', data.farm_name)
        break;
      ...
      case 3:
        ...
        console.log('Sowing Date:', data.sowing_date)
        break;
  ...
  const get_farms = async () => {
    ...
    console.log('Get Farms Function Calling');
    console.log(props.user_ids);
    console.log(props);
    ...
    console.log("All Farms Get API Calling", data);
  ...
  const sendform = async () => {
    ...
    console.log(data.farm_name+''+data.crop +''+  data.sowing_date +''+ data.area +''+season +'')
    if (data.farm_name == '' || data.crop == '' ||  data.sowing_date == '' || data.area == '' ||season == '') {
    ...
    let F_Data = {
      ...
      f_area: data.area,
      f_season:season,
      f_map:props.map_cord.cordinates,
    ...
    console.log("Farms Create API Calling", F_Data);
    ...
    .catch(err => {
      console.log('Farm Create API Failed', err)
      alert('Unable to Create Farm'+err);
    })
  };

  const farm_map = async () => {
    console.log('Farm Map Function Calling')
  };
