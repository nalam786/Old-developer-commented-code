...
const form_1 = (props) =>  {
  ...
  const get_farms = async () => {
    ...
    console.log("All Farms Get API Calling", F_Data);
    ...
    .then((resjson) => {
      ...
      if(resjson.Message == 'All Farms Get Successfully'){
        ...
        console.log(props.user_ids.farm_id);
  ...
  const sendform = async () => {
    ...
    if (data.farm_name == '' || data.crop == '' ||  data.sowing_date == '' || data.area == '' || data.season == '') {
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={{
          ...
          <View style={{alignSelf:"center",marginTop:30,width:"95%" }} >
            ...
            <View>
              <Button onPress={ ()=> farm_map() } style={[styles.input_button]} full >
