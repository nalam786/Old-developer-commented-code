...
const form_2 = props => {
  console.log(props.f_weed_eradication);
  ...
  console.log(
    'set',
    props.f_width_watercourse_water[index2].width_watercourse_water,
  );
  return (
    <>
      <View
        ...
        <View style={{alignSelf: 'center', marginTop: 30, width: '95%'}}>
          ...
          <View style={{flexDirection: 'column', marginTop: 30}}>
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                style={{alignSelf: 'center', borderRadius: 50}}
                value={1 == props.f_field_preparation[index2].field_preparation}
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                style={{alignSelf: 'center', borderRadius: 50}}
                value={2 == props.f_field_preparation[index2].field_preparation}
            ...
            <View>
              ...
              <View
                ...
                <DatePicker
                  ...
                  defaultDate={
                    new Date(props.f_levelled_date[index2].levelled_date)
                  }
                  locale={'en'}
          ...
          {props.f_watercourse_discharge[index2].watercourse_discharge == 0 ? (
            ...
            <View>
              ...
              <TextInput
                ...
                onFocus={() => focus()}
                onBlur={() => blur()}
                onChangeText={val => changeData(val, 25, index2)}
                value={props.f_bed_level[index2].bed_level}
                placeholder=""
                keyboardType="numeric"
                style={[styles.input_email]}
              />
