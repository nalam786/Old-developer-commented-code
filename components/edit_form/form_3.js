...
const form_3 = props => {
  ...
  const {
    ...
    f_water_source,
    f_canal_application,
    f_date_groundwater_application,
    f_water_source_other,
    f_canal_irrigation_date,
    index2,
  } = props;
        ...
        <View style={{alignSelf: 'center', marginTop: 30, width: '95%'}}>
          ...
          <View style={{marginTop: 20, height: '5%'}}>
            <Text style={styles.q_text}>
              Canal.irrigation.date (مٹی کی قسم)
            </Text>
            <Picker
              ...
              selectedValue={
                props.f_canal_irrigation_date[index2].canal_irrigation_date
              }>
          ...
          <View style={{flexDirection: 'column', marginTop: 30}}>
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                style={{alignSelf: 'center', borderRadius: 50}}
                value={
                  1 == props.ground_water_use[index2].ground_water
                }
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                style={{alignSelf: 'center', borderRadius: 50}}
                value={
                  2 == props.ground_water_use[index2].ground_water
                }
