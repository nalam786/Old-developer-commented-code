    ...
    <>
      <View style={{
        ...
        <View style={{alignSelf:"center",marginTop:30,width:"95%" }} >
          ...
          <View style={{ flexDirection: 'row',alignSelf:"center",marginTop:30, }}>
            ...
            <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
              <CheckBox 
                ...
                value={1==props.f__water_source[index2]._water_source}
                onValueChange={(val) => changeData(1,1,index2)}
              />
              <Text style={{alignSelf:"center", }} >Canal Water</Text>
            </View>

            <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >         
              <CheckBox 
                style={{alignSelf:"center",borderRadius:50, }}
                value={2==props.f__water_source[index2]._water_source}
                onValueChange={(val) => changeData(2,1,index2)}
              />
              <Text style={{alignSelf:"center" }} >tube-well</Text>           
            </View>
            
            <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
              <CheckBox 
                style={{alignSelf:"center",borderRadius:50, }}
                value={3==props.f__water_source[index2]._water_source}
          ...
          <Text>Flow of water course (Cusecs)</Text>
          ...
          <View style={{ flexDirection: 'row',alignSelf:"center",marginTop:30, }}>
            ...
            <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >
              <CheckBox 
                style={{alignSelf:"center",borderRadius:50, }}
                value={1==props.f_flow_water_source[index2]._flow_water_source}
            ...
            <View style={{ flexDirection: 'column',alignSelf:"center",flex:1 }} >         
              <CheckBox 
                style={{alignSelf:"center",borderRadius:50, }}
                value={2==props.f_flow_water_source[index2]._flow_water_source}
                onValueChange={(val) => changeData(2,2,index2)}
              />
              <Text style={{alignSelf:"center" }} >Not Known</Text>           
            </View>
