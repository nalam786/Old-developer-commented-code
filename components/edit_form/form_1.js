...
const form_1 = props => {
      ...
      .then(resjson => {
        ...
        if (resjson.Message == 'Farm Get Successfully') {
          setData({
            ...
            map: resjson.data[0].map,
          });

          // setData({
          //   ...data,
          //   updated_area: resjson.data[0].f_map,
          //   // .substring(
          //   //   1,
          //   //   yourString.length - 1,
          //   // )
  ...
  const getarray = str => {
    ...
    console.log(arr);
    props.nav.navigation.navigate('farm_map_edit', {
      map_upd_data: arr,
    });
  };
  ...
  console.log('testsaif');
  console.log(JSON.stringify(data.crop));
  return (
    <>
        ...
        <View
          ...
          <View style={{alignSelf: 'center', marginTop: 30, width: '95%'}}>
            ...
            <View style={[styles.input_email]}>
              <Picker
                onValueChange={(itemValue, itemIndex) =>
                  changeData(itemValue, itemIndex)
                }
            ...
            <View
              ...
              <DatePicker
                ...
                value={new Date(data.sowing_date)}
                locale={'en'}
                timeZoneOffsetInMinutes={undefined}
                modalTransparent={false}
                animationType={'fade'}
                androidMode={'default'}
                placeHolderText={'' + data.sowing_date}
            ...
            <View>
              <Button
                onPress={() => console.log(getarray(data.updated_area))}
            ...
            <View>
              <Button
                onPress={() => props.nav.navigation.navigate('farm_map_edit')}
                style={[styles.input_button]}
                full>
                <Text style={{color: 'white', fontSize: 15, fontWeight: '800'}}>
                  Farm Map
