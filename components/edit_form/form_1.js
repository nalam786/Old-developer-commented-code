...
const form_1 = props => {
    ...
    await fetch(URL.url + 'farms/farms_get', {
      ...
      .then(resjson => {
        if (resjson.Message == 'Farm Get Successfully') {
          ...
          let a = resjson.data[0].map.replace(
          ...
          setData({
            ...data,
            updated_area: JSON.parse(a).geometry.coordinates,
            // .substring(
            //   1,
            //   yourString.length - 1,
            // )
  ...
  // console.log(data.updated_area[0]);
  // var array = JSON.parse(JSON.stringify(data.updated_area[0]));
  // console.log(array.length);
  // console.log(typeof data.updated_area[0]);
  // for of
  // for (let obj of JSON.stringify(data.updated_area[0])) {
  //   console.log(obj[0]);
  // }
  // const polygon = data.updated_area[0][0].map(coordsArr => {
  //   let coords = {
