      ...
      {/* <ScrollView style={styles.scrollView}> */}
        ...
        <View style={{
          ...
          <View style={[{marginTop:20,flexDirection:'row',justifyContent:'space-between'}]} >
            ...
            <TextInput placeholderTextColor="#272626" onFocus={() => focus()} onBlur={() => blur()} onChangeText={(val) => changeData(val, 2, index2)} value={props.f_crop_yield[index2].crop_yield} keyboardType="numeric" placeholder="" style={[styles.input_email]} />
